// // ********************************************************************
// // 4. simple Debug https://medium.com/@reach2arunprakash/guvi-zen-simple-debugging-tasks-adcdc2d3249d
// // ************************************************************
...
// const newArray=[1,3,2,5,10,45,39,21,23,1,7,11,12,13];
...
// 6.Fix the code to gen Title caps.
// var arr = ["guvi", "geek", "zen", "fullstack"];
// (function() {
//  for (var i = 0; i < arr.length; i++) {
...
// 7.print all odd numbers in an array using IIFE function
...
// 9.Fix the code to remove duplicates.
...
// 10.Fix the code to give the below output:
// Expected Output:
// [
